...
const components: Components = {
  ...
  h1: ({ children }) => <h3 className="mb-1.5 mt-3 text-base font-bold text-white first:mt-0">{children}</h3>,
  h2: ({ children }) => <h3 className="mb-1.5 mt-3 text-base font-bold text-white first:mt-0">{children}</h3>,
  h3: ({ children }) => <h3 className="mb-1.5 mt-3 text-sm font-bold text-white first:mt-0">{children}</h3>,
