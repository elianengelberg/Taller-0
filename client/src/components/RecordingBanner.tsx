  ...
  if (status === "processing") {
    return (
      <div className="pointer-events-none absolute left-1/2 top-4 -translate-x-1/2">
        <div className="rounded-full bg-ink-800/90 px-3 py-1.5 text-xs font-medium text-white shadow-soft">
  ...
  if (status === "error") {
    return (
      <div className="absolute left-1/2 top-4 -translate-x-1/2 px-4">
        <div className="flex items-center gap-2 rounded-xl bg-red-600/90 px-3 py-2 text-xs font-medium text-white shadow-soft">
    ...
    <div className="absolute left-1/2 top-4 w-full max-w-sm -translate-x-1/2 px-4">
      <div className="rounded-xl border border-ink-700 bg-ink-800 p-3 shadow-soft">
        <div className="flex items-start justify-between gap-2">
          <p className="text-sm font-semibold text-white">Grabación lista</p>
          <button
            type="button"
            onClick={onDismiss}
        ...
        {resultUrl && (
          <a
            ...
            className="mt-3 flex items-center justify-center gap-2 rounded-lg bg-brand-500 px-3 py-2 text-sm font-semibold text-white hover:bg-brand-600"
          >
